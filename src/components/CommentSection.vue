    ...
    <div class="flex flex-col space-y-4">
        <div class="flex flex-col space-y-2 w-full md:w-3/5 lg:w-1/2">
            <textarea v-model="newComment" placeholder="Escribe un comentario..."
                class="p-3 border-4 border-[#eddaab] rounded-bl-lg text-lg"></textarea>
            <button @click="addComment" class="text-2xl p-2 btn bg-[#B66141] rounded-3xl text-white">
                Agregar un Comentario!!
            </button>
        </div>
        <div class="mx-auto">
            <transition-group name="fade" tag="div" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-1">
