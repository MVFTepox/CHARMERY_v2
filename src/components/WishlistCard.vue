        ...
        <div class="flex flex-col justify-between h-full w-1/2 p-3">
            ...
            <div>
                <div class="rounded-full bg-[#eddaab]  m-1 flex  justify-between w-24" style="height:30px ;">
                    ...
                    <input type="text" v-model="productQuantity"  class="caret-[#662f25] bg-[#eddaab] placeholder:text-[#662f25] text-center w-[30px] outline-none" />
                    <button type="button" @click="quantityIncrement" class="hover:bg-[#cb8844] rounded-e-full flex items-center px-1" >
                        <span class="material-symbols-rounded" style="color: #b66141;">
                            add
                        </span>
                    </button>
                ...
                <div class="flex justify-between">
                    ...
                    <button>
                        <span class="material-symbols-rounded align-middle trash" >
                        delete
                        </span>
                    </button>
