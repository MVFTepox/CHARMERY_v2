        ...
        <div class="md:col-span-8 mb-4">
            <div class="border-2 rounded-lg p-4 grid grid-cols-1 border-[#EDDAAB]">
                ...
                <div class="flex gap-4 flex-row-reverse">
                    <input class="btn bg-[#B66141] text-[#EDDAAB] rounded-2xl hover:text-black" type="button"
                        value="Pagar">
                        <input @click="nextStep" class="btn bg-[#B66141] text-[#EDDAAB] rounded-2xl hover:text-black" type="button" value="Crear Nuevo Metodo de Pago">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 mb-4">
                            <div>
                                ...
                                <input v-model="nombre"
                                    :class="['form-control', 'border-2', 'rounded-3xl', 'px-4', 'pt-0.5', 'border-[#B66141]', 'w-full', 'lg:w-10/12', { 'border-red-500': showError && isFieldEmpty(nombre) }]"
                                    type="text" />
                            </div>
                            <div>
                                <p class="text-2xl py-0.5 font-sans">Apellido</p>
                                <input v-model="apellido"
                                    :class="['form-control', 'border-2', 'rounded-3xl', 'px-4', 'pt-0.5', 'border-[#B66141]', 'w-full', 'lg:w-10/12', { 'border-red-500': showError && isFieldEmpty(apellido) }]"
                                    type="text" />
                            </div>
                        </div>
                        <div class="mb-4">
                            ...
                            <input v-model="correo"
                                :class="['form-control', 'border-2', 'rounded-3xl', 'px-4', 'pt-0.5', 'border-[#B66141]', 'w-full', 'lg:w-9/12', { 'border-red-500': showError && isFieldEmpty(correo) }]"
                                type="text" />
                        </div>
                        <div class="mb-4">
                            <div>
                            ...
                            <label class="flex items-center gap-2 border-none focus:aparece-none w-2/5">
                                ...
                                <input v-model="telefono"
                                    :class="['grow', 'border-2', 'rounded-3xl', 'px-4', 'pt-0.5', 'border-[#B66141]', { 'border-red-500': showError && isFieldEmpty(telefono) }]"
                                    type="number" placeholder="" />
                            </label>
                        </div>
                    </div>
                    <button @click="nextStep"
                        class="btn bg-[#B66141] text-[#EDDAAB] relative right-12 lg:right-16 w-2/5 lg:w-1/4 rounded-full hover:text-black">Siguiente</button>
                    ...
                    <div :class="{ 'slide-down': step >= 2 }" v-if="step >= 3">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 mb-4">
                            <div class="mb-4">
                                ...
                                <input v-model="pais"
                                    :class="['form-control', 'border-2', 'rounded-3xl', 'px-4', 'pt-0.5', 'border-[#B66141]', 'w-10/12', { 'border-red-500': showError && isFieldEmpty(pais) }]"
                                    type="text" />
                            </div>
                            <div class="mb-4">
                                <p class="text-2xl py-0.5 font-sans">Estado</p>
                                <input v-model="estado"
                                    :class="['form-control', 'border-2', 'rounded-3xl', 'px-4', 'pt-0.5', 'border-[#B66141]', 'w-10/12', { 'border-red-500': showError && isFieldEmpty(estado) }]"
                                    type="text" />
                            </div>
                            <div class="mb-4">
                                <p class="text-2xl py-0.5 font-sans">Ciudad</p>
                                <input v-model="ciudad"
                                    :class="['form-control', 'border-2', 'rounded-3xl', 'px-4', 'pt-0.5', 'border-[#B66141]', 'w-10/12', { 'border-red-500': showError && isFieldEmpty(ciudad) }]"
                                    type="text" />
                            </div>
                            <div class="mb-4">
                                <p class="text-2xl py-0.5 font-sans">Código Postal</p>
                                <input v-model="codigoPostal"
                                    :class="['form-control', 'border-2', 'rounded-3xl', 'px-4', 'pt-0.5', 'border-[#B66141]', 'w-10/12', { 'border-red-500': showError && isFieldEmpty(codigoPostal) }]"
                                    type="text" />
                            </div>
                            <div class="mb-4">
                                <p class="text-2xl py-0.5 font-sans">Colonia</p>
                                <input v-model="colonia"
                                    :class="['form-control', 'border-2', 'rounded-3xl', 'px-4', 'pt-0.5', 'border-[#B66141]', 'w-10/12', { 'border-red-500': showError && isFieldEmpty(colonia) }]"
                                    type="text" />
                            </div>
                            <div class="mb-4">
                                <p class="text-2xl py-0.5 font-sans">Calle y Número</p>
                                <input v-model="calleNumero"
                                    :class="['form-control', 'border-2', 'rounded-3xl', 'px-4', 'pt-0.5', 'border-[#B66141]', 'w-10/12', { 'border-red-500': showError && isFieldEmpty(calleNumero) }]"
                                    type="text" />
                            </div>
                            <div class="mb-4">
                                <p class="text-2xl py-0.5 font-sans">Apto., suite., unidad, etc.</p>
                                <input v-model="apto"
                                    :class="['form-control', 'border-2', 'rounded-3xl', 'px-4', 'pt-0.5', 'border-[#B66141]', 'w-10/12', { 'border-red-500': showError && isFieldEmpty(apto) }]"
                                    type="text" />
                            </div>
                        </div>
                        <div>
                    ...
                    <div :class="{ 'slide-down': step >= 3 }" v-if="step >= 4">
                        ...
                        <div class="grid grid-cols-3 gap-4 my">
                            <button class="btn rounded-2xl custom-border text-lg     lg:text-3xl text-[#662F25] py-1"
                                @click="mostrarComponente('transferencias')"  type="button">Transferencias</button>
                            <button class="btn rounded-2xl custom-border text-md md:text-11px lg:text-3xl text-[#662F25] py-1 "
                                @click="mostrarComponente('credito')" type="button">Débito y Crédito</button>
                            <button class="btn rounded-2xl custom-border text-lg lg:text-3xl text-[#662F25] py-1"
                                @click="mostrarComponente('efectivo')" type="button">Efectivo</button>
                        </div>
                        <div>
                        ...
                        <button type="button"
                            class="btn bg-[#B66141] text-[#EDDAAB] rounded-full w-2/4 relative top-10 hover:text-black">Finalizar</button>
                    </div>
                </div>
            </div>
        </div>
